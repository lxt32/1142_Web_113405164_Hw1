...
export default function Creations() {
  ...
  const creationsData = [
    ...
    { id: 7, title: "插畫作品", description: "", imageUrl: "/doodle.jpg", span: "col-span-1", detailDescription: "看了Wednesday第二季後很喜歡的角色Agnes。" },
    { id: 8, title: "插畫作品", description: "", imageUrl: "/vocaloid.png", span: "col-span-2", detailDescription: "我都說他們是軟體。" },
    { id: 9, title: "插畫作品", description: "", imageUrl: "/cola2.png", span: "col-span-1", detailDescription: "畫了朋友的角色。" },
